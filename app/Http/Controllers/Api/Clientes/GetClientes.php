...
class GetClientes extends Controller
{
    ...
    {
        $clientes = DB::select('select id_clientes, clientes.nombre, apellido, apodo, cuit, direccion, mail,
                                    telefono,localidad, provincias.nombre as provincia, created_at as fecha, id_provincia, encuesta from samira.clientes
