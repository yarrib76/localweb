...
class ControllerFacturaWeb extends Controller
{
    ...
    public function facturar(){
        ...
        DB::transaction(function () use (
            ...
            // Primero recorremos los artículos para calcular la ganancia total, 
            // descontar el stock y agregar los artículos a la factura.
            ...
            if($esPedido == "SI"){
                ...
                //Si esta en listo para envío, llamo a crear notificaciones
                if ($listoParaEnvio){
