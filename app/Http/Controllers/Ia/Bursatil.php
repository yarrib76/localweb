...
class Bursatil extends Controller
{
    ...
    public function getPrompt($datosBursatiles)
    {
        $prompt = "Necesito que con los datos que te voy a proporcionar en formato json, hagas un analisis y me devuelvas lo siguiente:\n"
                ...
                . "4. Para responer los puntos 1,2 y 3 debes utilizar en el analisis técnico retroceso de Fibonacci"
                . "Datos con información de la acción en fotmato Json\n"
                . ". $datosBursatiles .\n"
                . "Solo necesito que la respuesta sea en formato json con los siguiente item Symbol, Probabilidad de Ganar , Dias, Detalle, precioAccion, porcentaje. En detalle, hacer un pequeño resumen del analisis, especificando todos los indicadores técnicos y noticias que utilizaste para el resumen. \n"
